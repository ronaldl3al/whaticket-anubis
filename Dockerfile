...
RUN apt-get update && apt-get install -y wget gnupg ca-certificates postgresql-client git --no-install-recommends \
    ...
    && apt-get update && apt-get install -y google-chrome-stable fonts-ipafont-gothic fonts-wqy-zenhei fonts-thai-tlwg fonts-kacst fonts-freefont-ttf libxss1 --no-install-recommends --fix-missing \
